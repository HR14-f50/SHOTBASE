  ...
  <div class="profileAreaC">
    ...
    <form method="post" data-bulk-tags>
      ...
      <details class="settingsCard bulkTagPanel"><summary>写真にタグを一括追加</summary>
        ...
        <div class="tagList"><?php foreach ($tags as $tag): ?><label class="tagChoice" style="<?= h(profileTagStyle($tag)) ?>"><input type="checkbox" name="bulk_tags[]" value="<?= (int)$tag['id'] ?>"><span>#<?= h($tag['name']) ?></span></label><?php endforeach; ?></div>
